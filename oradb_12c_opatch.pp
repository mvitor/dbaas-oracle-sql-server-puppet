...
oradb::opatchupgrade{'12000_opatch_upgrade_db':
   oracle_home               => $oracle_home,
   patch_file                => $facts[pathc,
   csi_number                => undef,
   support_id                => undef,
 ...
 oradb::opatch{'24701882_db_patch':
  ensure                    => 'present',
  oracle_product_home       => $oracle_home,
  patch_id                  => '24701882',
  patch_file                => 'p24701882_121010_Generic.zip',
  clusterware               => false,
